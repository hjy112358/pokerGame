	...
	export default {
		...
		methods: {
				...
				if (msg == 1) {
					...
					switch (result.cardKind) {
						...
						case 'PAIRS':
							...
							myaudio.play();
							_this.girsrc = '/static/image/gif/PAIRS.gif';
							break;
							// 顺子
						case 'PROGRESSION':
							var myaudio = new Audio();
							...
							myaudio.play();
							_this.girsrc = '/static/image/gif/PROGRESSION.gif';
							break;
							//三不带
						case 'THREE':
							var myaudio = new Audio();
							...
							myaudio.play();
							_this.girsrc = '/static/image/gif/THREE.gif';
							break;
							//炸弹
						case 'BOMB':
							var myaudio = new Audio();
							...
							myaudio.play();
							_this.girsrc = '/static/image/gif/BOMB.gif';
							break;
							//王炸
						case 'KINGBOMB':
							var myaudio = new Audio();
							...
							myaudio.play();
							_this.girsrc = '/static/image/gif/KINGBOMB.gif';
							break;
							//三带一
						case 'THREE_ONE':
							var myaudio = new Audio();
							...
							myaudio.play();
							_this.girsrc = '/static/image/gif/THREE_ONE.gif';
							break;
							//三带二
						case 'THREE_TWO':
							var myaudio = new Audio();
							...
							myaudio.play();
							_this.girsrc = '/static/image/gif/THREE_TWO.gif';
							break;
							//四带二
						case 'FOUR_TWO':
							var myaudio = new Audio();
							...
							myaudio.play();
							_this.girsrc = '/static/image/gif/FOUR_TWO.gif';
							break;
							//四带二对
						case 'FOUR_PAIRS':
							var myaudio = new Audio();
						...
						case 'PROGRESSION_PAIRS':
							...
							myaudio.play();
							_this.girsrc = '/static/image/gif/PROGRESSION_PAIRS.gif';
							break;
						...
						case 'PLANE':
							...
							myaudio.play();
							_this.girsrc = '/static/image/gif/PLANE.gif';
							break;
							//飞机带单
						case 'PLANE_ONE':
							var myaudio = new Audio();
				...
				if (type == 1) {
					if (this.type1data.isSureRepeat && this.isSureland) {
						...
						if (msg == 0) {
							// 抢地主
							var myaudio = new Audio();
							myaudio.src = '/static/audio/need.mp3';
							myaudio.play()
						} else {
							// 不抢
							var myaudio = new Audio();
							myaudio.src = '/static/audio/noneed.mp3';
							myaudio.play()
						}
					...
					if (msg == 0) {
						// 加倍
						var myaudio = new Audio();
						myaudio.src = '/static/audio/double.mp3';
						myaudio.play()
					} else {
						// 不加倍
						var myaudio = new Audio();
						myaudio.src = '/static/audio/nodouble.mp3';
						myaudio.play()
					}
					if (which == 'left') {
						clearInterval(this.leftbtnmsg.timeleft);
			...
			finish(id) {
				...
				if (isnull) {
					if (winLose[0] == 1) {
						resultList[0].point = parseInt(resultList[0].point) - parseInt(minus);
					} else {
						resultList[1].point = parseInt(resultList[1].point) - parseInt(minus) / 2;
						resultList[2].point = parseInt(resultList[2].point) - parseInt(minus) / 2;
					}
				}
